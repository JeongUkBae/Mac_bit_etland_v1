	 ...
	 <div id="wrapper" class="grid-full-container container-fluid"> 
		...
		<div class="top" id="top" >
			...
			<div class="navibar" id="navibar">
				...
				<nav class="navbar navbar-default" role="navigation">
					...
					<div class="container">
					     <div class="navbar-header">
					        ...
					        <!-- Logo text or image -->
					        <a class="navbar-brand" href="intro.jsp">Bit_etland</a>
 			...
 			<div class="content" id="content" style="backdrop:static; keyboard: false;">
				      ...
				      <div id="introCarousel" class="carousel slide carousel-fade" data-ride="carousel">
				        ...
				        <div class="carousel-inner" role="listbox">
				          ...
				          <div class="item active">
				            <div class="carousel-background"><img src="${img}/mackbook.jpg" alt=""></div>
				            <div class="carousel-container">
				              <div class="carousel-content">
				                <h2 class="animated fadeInDown">NoteBook</h2>
				          ...
				          <!-- Slide 2 -->
				          <div class="item">
				            <div class="carousel-background"><img src="${img}/desktop.jpg" alt=""></div>
				            <div class="carousel-container">
				              <div class="carousel-content">
				                <h2 class="animated fadeInDown">DeskTop</span></h2>
				                <p class="animated fadeInUp">Ut velit est quam dolor ad a aliquid qui aliquid. Sequi ea ut et est quaerat sequi nihil ut aliquam. Occaecati alias dolorem mollitia ut. Similique ea voluptatem. Esse doloremque accusamus repellendus deleniti vel. Minus et tempore modi architecto.</p>
				                <a href="#about" class="btn-get-started animated fadeInUp">Read More</a>
				              </div>
				            </div>
				          ...
				          <!-- Slide 3 -->
				          <div class="item">
				            <div class="carousel-background"><img src="${img}/iphone.jpg" alt=""></div>
				            <div class="carousel-container">
				              <div class="carousel-content">
				                <h2 class="animated fadeInDown">Mobile Phone</span></h2>
				                <p class="animated fadeInUp">Ut velit est quam dolor ad a aliquid qui aliquid. Sequi ea ut et est quaerat sequi nihil ut aliquam. Occaecati alias dolorem mollitia ut. Similique ea voluptatem. Esse doloremque accusamus repellendus deleniti vel. Minus et tempore modi architecto.</p>
				                <a href="#about" class="btn-get-started animated fadeInUp">Read More</a>
				              </div>
				            </div>
			...
			<div class="parllax2" id="parllax2">
			  <!-- Parallax 2 -->
